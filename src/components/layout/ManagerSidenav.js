    ...
    return (
        <>
            ...
            <Menu theme="light" mode="inline">
                ...
                <Menu.Item key="4">
                    <NavLink to="/manager/EmployeeDetails">
                        <span
                            className="icon"
                            style={{
                ...
                <Menu.Item key="2">
                    <NavLink to="/manager/ViewHoliday">
                        <span
                            className="icon"
                            style={{
                        ...
                        <span className="label">View Holiday</span>
                    </NavLink>
                </Menu.Item>
                <Menu.Item key="3">
                    <NavLink to="/manager/ApplyLeave">
                        <span
                            className="icon"
                            style={{
                                background: page === "Add Employee" ? color : "",
                            }}
                        >
                            {billing}
                        </span>
                        <span className="label">Apply for Leave</span>
                    </NavLink>
                </Menu.Item>
                <Menu.Item key="7">
                    <NavLink to="/manager/LeaveStatus">
                ...
                <Menu.Item key="6">
                    <NavLink to="/manager/ApplyComp">
                        ...
                        <span className="label">Apply for Comp Offs</span>
                    </NavLink>
                </Menu.Item>


                <Menu.Item key="4">
                    <NavLink to="/manager/Changepw">
                        <span
                            className="icon"
                            style={{
                                background: page === "rtl" ? color : "",
